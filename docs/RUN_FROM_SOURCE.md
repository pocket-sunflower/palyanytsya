...
3. Відкрийте командний рядок: 
   ...
   Команди з наступних кроків вводіть у відкрившийся командний рядок.
...
Після першого налаштування, процес запуску набагато швидше:
...
6. Перейдіть до папки, в яку ви завантажете паляницю. Наприклад:
   ```bash
   cd ~/Downloads
   ```
